...
GtkWidget* get_unit_edit_dialog(void) {
	...
	if(!unitedit_builder) {
		...
		gtk_builder_add_callback_symbols(unitedit_builder, "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_edit_combo_system_changed", G_CALLBACK(on_unit_edit_combo_system_changed), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_edit_entry_name_changed", G_CALLBACK(on_unit_edit_entry_name_changed), "on_unit_edit_button_names_clicked", G_CALLBACK(on_unit_edit_button_names_clicked), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_edit_combobox_class_changed", G_CALLBACK(on_unit_edit_combobox_class_changed), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_edit_checkbutton_mix_toggled", G_CALLBACK(on_unit_edit_checkbutton_mix_toggled), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_edit_spinbutton_exp_value_changed", G_CALLBACK(on_unit_edit_spinbutton_exp_value_changed), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_entry_key_press_event", G_CALLBACK(on_unit_entry_key_press_event), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_unit_edit_entry_relation_changed", G_CALLBACK(on_unit_edit_entry_relation_changed), "on_math_entry_key_press_event", G_CALLBACK(on_math_entry_key_press_event), "on_unit_changed", G_CALLBACK(on_unit_changed), "on_math_entry_key_press_event", G_CALLBACK(on_math_entry_key_press_event), "on_unit_changed", G_CALLBACK(on_unit_changed), NULL);
