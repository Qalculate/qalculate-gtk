...
GtkWidget* get_variable_edit_dialog(void) {
	...
	if(!variableedit_builder) {
		...
		gtk_builder_add_callback_symbols(variableedit_builder, "on_variable_changed", G_CALLBACK(on_variable_changed), "on_variable_edit_entry_name_changed", G_CALLBACK(on_variable_edit_entry_name_changed), "on_variable_edit_button_names_clicked", G_CALLBACK(on_variable_edit_button_names_clicked), "on_variable_edit_textview_value_key_press_event", G_CALLBACK(on_variable_edit_textview_value_key_press_event), "on_variable_changed", G_CALLBACK(on_variable_changed), "on_variable_edit_checkbutton_temporary_toggled", G_CALLBACK(on_variable_edit_checkbutton_temporary_toggled), "on_variable_edit_combo_category_changed", G_CALLBACK(on_variable_edit_combo_category_changed), "on_variable_changed", G_CALLBACK(on_variable_changed), "on_variable_changed", G_CALLBACK(on_variable_changed), "on_variable_changed", G_CALLBACK(on_variable_changed), NULL);
